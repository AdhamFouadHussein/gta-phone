...
export default function SignUpCreateNickName() {
  ...
  const {
    setNickname: setNicknameInStore,
    email,
    password,
    nickname: userName,
  } = useSignupStore(); // Zustand action to set nickname
  ...
  const handleNuiMessage = (event: MessageEvent) => {
    ...
    if (data.type === "T_USER") {
      login({
        ...
        userName: data.payload.Nickname,
    ...
    >
      <div className="nickname-page-container">
        ...
        <div className="description">
          This can be anything you like and can be changed later. If you skip
          this step, you will be automatically assigned a default nickname.
        </div>
